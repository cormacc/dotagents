...
| `ORCH_POLL_INTERVAL_MS` | parent | Sleep between settled-without-result wait iterations, and between `collect --any` poll ticks. Unset, blank, unparseable, zero, and negative values all fall back to 1000 ms. |
